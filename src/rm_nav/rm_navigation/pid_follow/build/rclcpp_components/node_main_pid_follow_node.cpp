...
#define NODE_MAIN_LOGGER_NAME "pid_follow_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpid_follow.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pid_follow_>";
